...
function toMatchSnapshot(received, nameOrOptions, optOptions = {}) {
  ...
  const {
    ...
    diffPath,
    mimeType
  } = (0, _golden.compare)(received, pathSegments, testInfo.snapshotPath, testInfo.outputPath, testInfo.retry < testInfo.project.retries ? 'none' : testInfo.config.updateSnapshots, withNegateComparison, options);
