...
var _gridServer = require("playwright-core/src/grid/gridServer");

var _dockerGridFactory = _interopRequireDefault(require("playwright-core/src/grid/dockerGridFactory"));
...
function addTestCommand(program) {
  ...
  command.addOption(new _commander.Option('--reuse-context').hideHelp());
...
async function createLoader(opts) {
  ...
  if (opts.headed || opts.debug || opts.reuseContext) overrides.use = {
    headless: false
  };
  ...
  if (opts.reuseContext) process.env.PWTEST_REUSE_CONTEXT = '1';
